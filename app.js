...
const fortunes = [
  {
    rank: "🎯 大吉",
    message: "ええ波来とる！思い切って一歩踏み出したら、想像以上に広がるで。",
  },
  {
    rank: "🌟 中吉",
  ...
  {
    rank: "🙂 吉",
    message: "肩の力を抜いたら、うまく回りだす。小さな良いことが重なるで～。",
  },
  {
    rank: "🍀 小吉",
    message: "地味でも積み上げ最強。コツコツが未来のドヤ顔をつくるんよ。",
  },
  {
    rank: "🌈 末吉",
    message: "焦らんでOK。準備が整ったら、チャンスはちゃんと来るけん。",
  },
  {
    rank: "⚡ 凶(チャンス)",
    message: "無理せんのが勝ち。計画見直しで逆転できる。寝たらだいたい元気出る。",
  },
];

const colors = ["さくらピンク", "ミントグリーン", "ラベンダー", "ネイビー", "レモンイエロー", "コーラル"];
const items  = ["お気に入りペン", "水筒", "イヤホン", "ふわふわ靴下", "ノート", "ハンドクリーム"];
const actions = [
  "2分だけ深呼吸する",
  "『ありがとう』を1回多めに言う",
  "机の上を30秒だけ片付ける",
